$(document).ready(function(){
	...
	function initialize() {
		...
		var pyrmont = new google.maps.LatLng(7.38778, 3.89639);
		...
		var request = {
			location: pyrmont,
			radius: 1000,
			types: [ "hotel", "fueling station", "restaurant", "cafe", "bar", "grocery_or_supermarket", "parks", "school", "shopping_mall", "movie_theater", "bank", "university"],
		};

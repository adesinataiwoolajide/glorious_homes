    ...
    <div id="rev_slider_third" class="rev_slider"  data-version="5.0">
        <ul>
            ...
            <li data-transition="fade">
                <img src="{{asset('design/images/home3-banner1.jpg')}}" alt="" data-bgposition="center center" 
                data-bgfit="cover">
            ...
            <li data-transition="fade">
                <img src="{{asset('design/images/home3-banner2.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover">
                <div class="black-caption tp-caption tp-resizeme"
                    data-x="['left','left','center','center']" data-hoffset="['0','0','0','15']" 
                    data-y="['center','center','center','center']" data-voffset="['0','0','0','0']" 
                    data-responsive_offset="on"
            ...
            <li data-transition="fade">
                <img src="{{asset('design/images/home3-banner3.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover">
                <div class="black-caption tp-caption tp-resizeme"
                    data-x="['left','left','center','center']" data-hoffset="['0','0','0','15']" 
                    data-y="['center','center','center','center']" data-voffset="['0','0','0','0']" 
                    data-responsive_offset="on"

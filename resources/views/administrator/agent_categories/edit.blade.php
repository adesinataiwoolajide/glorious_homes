   			...
   			<div class="row pt-2 pb-2">
		        <div class="col-sm-9">
				    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('agent.category.edit', $categ->agent_category_id)}}">Edit  Category</a></li>
						...
						@endif
			            <li class="breadcrumb-item active" aria-current="page">Editing Agent Categories</li>
			         </ol>
			   	</div>
			</div>
   			<div class="row">
		    	<div class="col-lg-12">
		    		...
		    		@include('partials._message')
		          	<div class="card">
		            	<div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Update Agent Category Details</div>
	            		<div class="card-body">
	            			<form action="{{route('agent.category.update',$categ->agent_category_id)}}" method="POST" enctype="multipart/form-data">
	            				{{ csrf_field() }}
		            			<div class="form-group row ">
		            				<div class="col-sm-6">
                                        <input type="text" class="form-control form-control-rounded" name="agent_category_name" value="{{$categ->agent_category_name}}" required placeholder="Enter The Category Name">
                                        <input type="hidden" name="prev_name" value="{{$categ->agent_category_name}}">
					                ...
					                <div class="col-sm-6" align="center">
					                    <button type="submit" class="btn btn-success btn-lg btn-block">UPDATE THE AGENT  CATEGORY </button>
					                </div>

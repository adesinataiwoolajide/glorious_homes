                            ...
                            <form action="{{route('subscription.save')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        ADD THE AGENT SUBCRIPTION</button>
                                    </div>
                ...
                <div class="card">
                    ...
                    @if(count($subscription) ==0)
                        <div class="card-header" align="center" style="color: red"><i class="fa fa-table"></i> 
                            @if(auth()->user()->hasPermissionTo('Delete Subscription') OR 
                                ...
                                List of All Agent Subscriptions is Empty</div>
                            @else 
                                {{$age->agent_name}} No Subscription Was Found for You
                            @endif
                        </div>
                    ...
                    @else
                        <div class="card-header"><i class="fa fa-table"></i> 
                            @if(auth()->user()->hasPermissionTo('Delete Subscription') OR 
                                (Gate::allows('Administrator', auth()->user())))
                                List of All Agent Subscriptions</div>
                            @else 
                                List of All {{$age->agent_name}} Subscriptions
                            @endif
                        <div class="card-body">

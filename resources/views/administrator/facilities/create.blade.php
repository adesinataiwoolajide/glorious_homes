   			...
   			<div class="row pt-2 pb-2">
		        <div class="col-sm-12">
				    <ol class="breadcrumb">
						...
						@endif
			            <li class="breadcrumb-item active" aria-current="page">Adding Property Facilities</li>
			         </ol>
			   	</div>
			</div>
   			<div class="row">
		    	<div class="col-lg-12">
		    		...
		    		@include('partials._message')
		          	<div class="card">
		            	<div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Add New Property Facility</div>
	            		<div class="card-body">
	            			<form action="{{route('facility.save')}}" method="POST" enctype="multipart/form-data">
		            			...
		            			<div class="form-group row ">
					                ...
					                <div class="col-sm-6" align="center">
					                    <button type="submit" class="btn btn-success btn-lg btn-block">ADD THE PROPERTY FACILITY </button>
					                </div>
			...
			<div class="row">
		    	<div class="col-lg-12">
		          	<div class="card">
			            ...
			            @else
			            	<div class="card-header"><i class="fa fa-table"></i> List of Saved Property Facilities</div>
		            		<div class="card-body">
							                    ...
							                    <tr>
													<td>{{$number}}
														@if(auth()->user()->hasPermissionTo('Edit Facility') OR 
															...
															<a href="{{route('facility.delete', $facilities->facility_id)}}" 

        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    @endif
                    <li class="breadcrumb-item active" aria-current="page">List of Available properties </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    @if (Gate::allows('Administrator', auth()->user()) OR (auth()->user()->hasRole('Admin')))
                        @if(count($property) ==0)
                            <div class="card-header" align="center" style="color: red"><i class="fa fa-table"></i> 
                                The List of All Available Properties is Empty
                            </div>

                        @else
                            <div class="card-header"><i class="fa fa-table"></i> List of All Available Properties</div>
                            <div class="card-body">
                    ...
                    @else
                        @if(count($proper) ==0)
                            <div class="card-header" align="center" style="color: red"><i class="fa fa-table"></i> 
                               {{$agent->agent_name}} You Have Not Added Any New Property
                            </div>

                        @else
                            <div class="card-header"><i class="fa fa-table"></i> {{$agent->agent_name}} List of All Your Available Properties</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="default-datatable" class="table table-bordered">
                                        <thead>

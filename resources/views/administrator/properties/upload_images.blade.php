                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('property.save')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-3">
                                    <label>Size</label>
                                    <input type="number" name="size" required placeholder="Please Enter The Size" 
...
{{-- <script>
        ...
        $('#property_category_id').on('change',function(e){
            console.log(e);
            var sub = e.target.value;
            //console.log(cat_id);
            //ajax
            $.get('/ajax-subcat?property_category_id=' + property_category_id, 
                function(data){
                //success data
                // console.log(data);
                $('#sub').empty();
                $.each(data,function(index,subcatObj){
                    ...
                    $(#sub).append('<option value ="'+subcatObj.property_type_id+'">'+subcatObj.property_type_name+'</option>');
                });
            });
        });

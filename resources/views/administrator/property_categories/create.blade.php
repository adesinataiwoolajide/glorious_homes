   			...
   			<div class="row pt-2 pb-2">
		        <div class="col-sm-12">
				    <ol class="breadcrumb">
						...
						@endif
			            <li class="breadcrumb-item active" aria-current="page">List of Saved Property Categories</li>
			         </ol>
			   	</div>
			</div>
   			<div class="row">
		    	<div class="col-lg-12">
		    		...
		    		@include('partials._message')
		          	<div class="card">
		            	<div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Add New Property Category Details</div>
	            		<div class="card-body">
	            			<form action="{{route('property.category.save')}}" method="POST" enctype="multipart/form-data">
	            				{{ csrf_field() }}
		            			<div class="form-group row ">
		            				<div class="col-sm-6">
					                    <input type="text" class="form-control form-control-rounded" name="property_category_name" required placeholder="Enter The Category Name">
					                ...
					                <div class="col-sm-6" align="center">
					                    <button type="submit" class="btn btn-success btn-lg btn-block">ADD THE PROPERTY CATEGORY </button>
					                </div>

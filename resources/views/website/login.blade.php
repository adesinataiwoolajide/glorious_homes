        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="text-uppercase">User Registration</h1>
                    ...
                    <ol class="breadcrumb text-center ">
                        ...
                        <li class="active">User Login/Registration</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="profile-login">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#user_login" aria-controls="user_login" role="tab" data-toggle="tab">Login</a></li>
                            <li role="presentation"><a href="#user_registration" aria-controls="user_registration" role="tab" data-toggle="tab">User Registration</a></li>
                        </ul>
                        <!-- Tab panes -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-6 text-right">
                                                    <a href="{{route('user.forgot')}}" class="lost-pass">Lost your password?</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" col-sm-12">
